...
sed -i 's/<entry id="RESUBMIT" value="0">/<entry id="RESUBMIT" value="4">/g' env_run.xml
sed -i 's/<entry id="RUN_TYPE" value="startup">/<entry id="RUN_TYPE" value="branch">/g' env_run.xml
sed -i 's,<entry id="RUN_REFDIR" value="ccsm4_init">,<entry id="RUN_REFDIR" value="/gscratch/arctic_tipping_point_results/ELR_E3SM_output_stash/master.A_WCYCL1850.ne4_oQU240.branch.tune.Golaz2019/run/">,g' env_run.xml
...
sed -i 's,<entry id="RUNDIR" value="/gscratch/$USER/acme_scratch/sandiatoss3/$CASE/run">,<entry id="RUNDIR" value="/gscratch/$USER/acme_scratch/sandiatoss3/$CASE/run">,g' env_run.xml
